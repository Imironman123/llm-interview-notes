...
| 文档 | 方向 | 覆盖内容 | 题量 |
|---|---|---|---|
| [**面经总索引**](md/00_面经总索引.md) | 总览 | 阅读路线 · 准备时间线 · 使用建议 | — |
| [字节跳动大模型面试复习手册 2025–2026](md/字节跳动大模型面试复习手册%202025至2026.md) | 字节专场 | **11 篇面经实录**：豆包 Seed、AI 应用研发、搜索推荐、Agent 平台、TikTok、飞书、AI Infra、推理优化等 | 97 |
| [字节跳动大模型面试_面经与真题复盘](md/字节跳动大模型面试_面经与真题复盘.md) | 字节专场 | 岗位版图与选岗 · 5 轮流程详解 · 字节面试风格 · 真题分类 · 避坑清单 | 23 |
| [大模型八股面试题_上_基础与架构](md/大模型八股面试题_上_基础与架构.md) | 八股 · 基础 | Transformer · 位置编码 RoPE/ALiBi · MHA/MQA/GQA · FlashAttention · MoE · 分词 · 采样 · Scaling Law | 27 |
| [大模型八股面试题_下_训练与微调](md/大模型八股面试题_下_训练与微调.md) | 八股 · 训练对齐 | 预训练与 Loss Spike · 混合精度 · ZeRO · 3D 并行 · LoRA/QLoRA · RLHF/PPO/GRPO · 蒸馏 | 34 |
| [RAG检索增强生成_面试专题](md/RAG检索增强生成_面试专题.md) | RAG | PDF 解析与分块 · Embedding 选型 · HNSW/IVF/PQ · BM25 与混合检索 · Rerank · 幻觉与评估 · 系统设计 | 35 |
| [AI_Agent开发_面试专题](md/AI_Agent开发_面试专题.md) | Agent | ReAct · Plan-and-Execute · Function Calling · **MCP** · 记忆系统与上下文工程 · 多 Agent 协作 · 评估与可观测 · 安全 · 系统设计 | 22 |
| [大模型推理优化与部署_面试专题](md/大模型推理优化与部署_面试专题.md) | 推理 / 部署 | Prefill/Decode · KV Cache 计算与优化 · PagedAttention · PD 分离 · GPTQ/AWQ/FP8 · 投机解码 · 服务化与成本 | 33 |
| [AI_Infra与大模型系统设计_面试专题](md/AI_Infra与大模型系统设计_面试专题.md) | Infra | GPU 架构与互联 · CUDA 编程与手撕算子 · 显存公式 · 并行策略 · 通信原语 · 推理系统 · 调度 · 性能调优 | 30 |
| [各大厂大模型面经合集_腾讯阿里百度快手等](md/各大厂大模型面经合集_腾讯阿里百度快手等.md) | 大厂横向 | 腾讯 / 阿里 / 百度 / 快手 / 美团 / 京东 / 小红书 / 华为 / 小米 / 讯飞 / 商汤 / 月之暗面 / 智谱 / MiniMax / DeepSeek —— 流程 · 真题 · 横向对比表 | 44 |
...
```
.
├── *.docx          # 原始 Word 文件（10 份）
├── md/             # Markdown 版本，可直接在线阅读
└── README.md
```

Markdown 由 pandoc 转换生成（`pandoc -f docx -t gfm --wrap=none`），公式、表格、代码块已尽量保留；如需精确排版请参考 `.docx` 原件。
